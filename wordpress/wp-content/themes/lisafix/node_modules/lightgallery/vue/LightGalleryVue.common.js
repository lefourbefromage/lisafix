  ...
  _createClass(LightGallery, [{
    ...
    value: function buildStructure() {
      ...
      if (this.settings.controls) {
        controls = "<button type=\"button\" id=\"".concat(this.getIdName('lg-prev'), "\" aria-label=\"Previous slide\" class=\"lg-prev lg-icon\"> ").concat(this.settings.prevHtml, " </button>\n                <button type=\"button\" id=\"").concat(this.getIdName('lg-next'), "\" aria-label=\"Next slide\" class=\"lg-next lg-icon\"> ").concat(this.settings.nextHtml, " </button>");
      }
      ...
      var closeIcon = this.settings.closable && this.settings.showCloseIcon ? "<button type=\"button\" aria-label=\"Close gallery\" id=\"".concat(this.getIdName('lg-close'), "\" class=\"lg-close lg-icon\"></button>") : '';
      var maximizeIcon = this.settings.showMaximizeIcon ? "<button type=\"button\" aria-label=\"Toggle maximize\" id=\"".concat(this.getIdName('lg-maximize'), "\" class=\"lg-maximize lg-icon\"></button>") : '';
      ...
      if (this.settings.download) {
        this.$toolbar.append("<a id=\"".concat(this.getIdName('lg-download'), "\" target=\"_blank\" aria-label=\"Download\" download class=\"lg-download lg-icon\"></a>"));
      }
    ...
    value: function refreshOnResize() {
      if (this.lgOpened) {
        ...
        var _this$getMediaContain = this.getMediaContainerPosition(),
            top = _this$getMediaContain.top,
            bottom = _this$getMediaContain.bottom;

        this.currentImageSize = lg_utils.getSize(this.items[this.index], this.$lgContent, top + bottom, videoInfo && this.settings.videoMaxSize);
    ...
    value: function openGallery() {
      ...
      if (this.zoomFromOrigin && element) {
        this.currentImageSize = lg_utils.getSize(element, this.$lgContent, top + bottom, this.galleryItems[index].__slideVideoInfo && this.settings.videoMaxSize);
        transform = lg_utils.getTransform(element, this.$lgContent, top, bottom, this.currentImageSize);
      }
    ...
    key: "onLgObjectLoad",
    value: function onLgObjectLoad($el, index, delay, speed, dummyImageLoaded) {
      var _this7 = this;
      ...
      $el.find('.lg-object').first().on('load.lg', function () {
        _this7.handleLgObjectLoad($el, index, delay, speed, dummyImageLoaded);
      });
      setTimeout(function () {
    ...
    value: function handleLgObjectLoad($el, index, delay, speed, dummyImageLoaded) {
      var _this8 = this;
    ...
    value: function loadContent(index, rec) {
      ...
      if (!$currentSlide.hasClass('lg-loaded')) {
        if (videoInfo) {
          ...
          var videoSize = lg_utils.getSize(this.items[index], this.$lgContent, top + bottom, videoInfo && this.settings.videoMaxSize);
          lgVideoStyle = this.getVideoContStyle(videoSize);
        }

        if (iframe) {
          var markup = lg_utils.getIframeMarkup(src, this.settings.iframeWidth, this.settings.iframeHeight, currentGalleryItem.iframeTitle);
          ...
          var _markup = lg_utils.getVideoPosterMarkup(poster, dummyImg || '', lgVideoStyle, videoInfo);

          $currentSlide.prepend(_markup);

          var _delay = (hasStartAnimation ? this.settings.startAnimationDuration : this.settings.backdropDuration) + 100;

          setTimeout(function () {
            _this10.LGel.trigger(lGEvents.hasVideo, {
              index: index,
              src: src,
      ...
      if (!this.lGalleryOn && this.zoomFromOrigin && this.currentImageSize) {
        ...
        if (!$currentSlide.hasClass('lg-loaded')) {
          setTimeout(function () {
            ...
            _this10.onLgObjectLoad($currentSlide, index, delay, _speed, true);
    ...
    value: function slide(index, fromTouch, fromThumb, direction) {
      ...
      if (!this.lgBusy) {
        ...
        setTimeout(function () {
          ...
          if (_this15.settings.appendSubHtmlTo === '.lg-sub-html') {
    ...
    key: "touchMove",
    value: function touchMove(startCoords, endCoords) {
      ...
      if (this.settings.enableSwipe) {
        ...
        this.$inner.on('touchmove.lg', function (e) {
          ...
          if (isSwiping && _this17.touchAction === 'swipe' && e.targetTouches.length === 1) {
            ...
            _this17.touchMove(startCoords, endCoords);
      ...
      if (!this.lgBusy) {
        if (this.index + 1 < this.galleryItems.length) {
          ...
          if (_loop) {
            ...
            setTimeout(function () {
              _this19.outer.removeClass('lg-right-end');
            }, 400);
          }
        }
      }
      ...
      if (!this.lgBusy) {
        if (this.index > 0) {
          ...
          if (_loop) {
            ...
            setTimeout(function () {
              _this20.outer.removeClass('lg-left-end');
            }, 400);
          }
        }
      }
    ...
    value: function keyPress() {
      ...
      $LG(window).on("keydown.lg.global".concat(this.lgId), function (e) {
        if (_this21.lgOpened && _this21.settings.escKey === true && e.keyCode === 27) {
          e.preventDefault();

          if (_this21.settings.allowMediaOverlap && _this21.outer.hasClass('lg-can-toggle') && _this21.outer.hasClass('lg-components-open')) {
            _this21.outer.removeClass('lg-components-open');
          } else {
            _this21.closeGallery();
          }
        }

        if (_this21.lgOpened && _this21.galleryItems.length > 1) {
          if (e.keyCode === 37) {
            e.preventDefault();

            _this21.goToPrevSlide();
          }

          if (e.keyCode === 39) {
            e.preventDefault();

            _this21.goToNextSlide();
          }
        }
      });
    }
    ...
    value: function mousewheel() {
      ...
      this.outer.on('mousewheel.lg', function (e) {
        if (!e.deltaY || _this23.galleryItems.length < 2) {
          return;
        }
    ...
    value: function toggleMaximize() {
      ...
      this.getElementById('lg-maximize').on('click.lg', function () {
        _this24.$container.toggleClass('lg-inline');

        _this24.refreshOnResize();
      });
    }
  }, {
    key: "invalidateItems",
    ...
    value: function manageCloseGallery() {
      ...
      if (this.settings.closeOnTap) {
        ...
        this.outer.on('mousedown.lg', function (e) {
          ...
          if (_this25.isSlideElement(target)) {
            mousedown = true;
          } else {
            mousedown = false;
          }
        ...
        this.outer.on('mouseup.lg', function (e) {
          ...
          if (_this25.isSlideElement(target) && mousedown) {
            if (!_this25.outer.hasClass('lg-dragging')) {
              _this25.closeGallery();
            }
          }
        });
    ...
    value: function closeGallery(force) {
      ...
      if (this.zoomFromOrigin && currentItem) {
        ...
        var imageSize = lg_utils.getSize(currentItem, this.$lgContent, top + bottom, this.galleryItems[this.index].__slideVideoInfo && this.settings.videoMaxSize);
        transform = lg_utils.getTransform(currentItem, this.$lgContent, top, bottom, imageSize);
      }
      ...
      setTimeout(function () {
        if (_this26.zoomFromOrigin && transform) {
          _this26.outer.removeClass('lg-zoom-from-image');
        }

        _this26.$container.removeClass('lg-show'); // Need to remove inline opacity as it is used in the stylesheet as well


        _this26.$backdrop.removeAttr('style').css('transition-duration', _this26.settings.backdropDuration + 'ms');

        _this26.outer.removeClass("lg-closing ".concat(_this26.settings.startClass));

        _this26.getSlideItem(_this26.index).removeClass('lg-start-end-progress');

        _this26.$inner.empty();

        if (_this26.lgOpened) {
          _this26.LGel.trigger(lGEvents.afterClose, {
            instance: _this26
          });
        }

        if (_this26.outer.get()) {
          _this26.outer.get().blur();
        }

        _this26.lgOpened = false;
      }, removeTimeout + 100);
    ...
    value: function destroy() {
      ...
      setTimeout(function () {
        _this27.destroyModules(true);

        if (!_this27.settings.dynamic) {
          _this27.invalidateItems();
        }

        $LG(window).off(".lg.global".concat(_this27.lgId));

        _this27.LGel.off('.lg');

        _this27.$container.remove();
      }, closeTimeout);
    }
  }]);
